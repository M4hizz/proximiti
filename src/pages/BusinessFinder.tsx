...
import { Compass, User, LogOut, LogIn, Shield, SlidersHorizontal, Sun, Moon } from "lucide-react";
...
export function BusinessFinder() {
  ...
  const filteredBusinesses = useMemo(() => {
    ...
    return filtered;
  }, [availableBusinesses, searchQuery, selectedCategory, userLocation, sortBy]);
